...
if has("gui_running")
  ...
  highlight link rubyAttribute Keyword highlight link rubyInstanceVariable Normal

  "Rails Colors
  highlight link railsMethod Type

  "Fugitive Colors
  " highlight DiffAdd gui=NONE guibg=Black guifg=Black
end
